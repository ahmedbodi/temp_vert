...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s $NameLowercase-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  $NameLowercase-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded $NameLowercase transaction") + "\n" +
              "  $NameLowercase-tx [options] -create [commands]   " + _("Create hex-encoded $NameLowercase transaction") + "\n" +
              "\n";
